...
const APK_URL = import.meta.env.VITE_APK_DOWNLOAD_URL ||
  "https://github.com/Iamhimanshu008/smartwaste-ai/releases/download/v2.3.4/SmartWasteAI-v2.3.4.apk";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="mb-8 w-full bg-slate-50 p-6 rounded-2xl border border-slate-100">
                <h4 className="text-sm font-bold text-slate-800 mb-4 uppercase tracking-wider">What's new in v2.3.4:</h4>
